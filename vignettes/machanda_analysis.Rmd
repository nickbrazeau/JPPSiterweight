...
means <- ret.ord.params.summ[4,]


curve(means[1]*(1-1/(1 +(x/means[2])^means[5]+(x/means[3])^means[6]+(x/means[4])^means[7])), add=TRUE,lwd=2,lty=2,col='black', ylab='Body Length', xlim = c(0,60))
